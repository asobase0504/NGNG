...
// 静的メンバー変数の宣言
//==============================================================
std::array<HFONT, CFont::FONT_MAX> CFont::m_hFont;
std::array<LOGFONT, CFont::FONT_MAX> CFont::m_lf;
std::array<LPDIRECT3DTEXTURE9, CFont::FONT_MAX> CFont::m_texFont;
...
{
	m_hFont[inTexture] = CreateFontIndirect(&m_lf[inTexture]);

	if (m_hFont[inTexture] == nullptr)
	{
		return;
	}
