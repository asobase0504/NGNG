...
{
	m_dates["YAMATO_SKILL_1"] = { 0,1,1,0,30,30,0.7f,0,D3DXVECTOR3(30.0f,30.0f,30.0f),
	...
	m_dates["YAMATO_SKILL_2"] = { 180,1,1,0,5,5,1.0,0,D3DXVECTOR3(30.0f,30.0f,30.0f),
		[this](CCharacter* inusedCharacter)
	{// 発動時の効果
		CSkillEntity* entity = nullptr;
		if (inusedCharacter != nullptr)
	...
	m_dates["YAMATO_SKILL_3"] = { 120,1,1,0,120,20,1.0,0,D3DXVECTOR3(30.0f,30.0f,30.0f),
	...
	{ // 発動時の効果
		...
		if (inusedCharacter != nullptr)
		{
			entity = CYamatoSkill_4::Create(inusedCharacter);
		}
		return entity;
	}};
	m_dates["GOLEM_SKILL_1"] = { 50,1,1,0,600,0,0,0,D3DXVECTOR3(30.0f,30.0f,30.0f),
		[this](CCharacter* inusedCharacter)
	{ // 発動時の効果
		CSkillEntity* entity = nullptr;
		if (inusedCharacter != nullptr)
